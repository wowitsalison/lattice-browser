...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 5783, monthCode: "M04", day: 1, hour: 12, minute: 34, calendar }, options).add(months2),
...
TemporalHelpers.assertPlainDateTime(
  Temporal.PlainDateTime.from({ year: 5783, monthCode: "M07", day: 1, hour: 12, minute: 34, calendar }).add(months2n),
