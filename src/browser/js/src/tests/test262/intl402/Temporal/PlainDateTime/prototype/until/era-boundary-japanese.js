...
const taisho15 = Temporal.PlainDateTime.from({ era: "taisho", eraYear: 15, monthCode: "M05", day: 20, hour: 12, minute: 34, calendar }, options);
const showa1 = Temporal.PlainDateTime.from({ era: "showa", eraYear: 1, monthCode: "M12", day: 30, hour: 12, minute: 34, calendar }, options);
const showa55 = Temporal.PlainDateTime.from({ era: "showa", eraYear: 55, monthCode: "M03", day: 15, hour: 12, minute: 34, calendar }, options);
const showa64 = Temporal.PlainDateTime.from({ era: "showa", eraYear: 64, monthCode: "M01", day: 3, hour: 12, minute: 34, calendar }, options);
const heisei1 = Temporal.PlainDateTime.from({ era: "heisei", eraYear: 1, monthCode: "M02", day: 27, hour: 12, minute: 34, calendar }, options);
const heisei30 = Temporal.PlainDateTime.from({ era: "heisei", eraYear: 30, monthCode: "M03", day: 15, hour: 12, minute: 34, calendar }, options);
const heisei31 = Temporal.PlainDateTime.from({ era: "heisei", eraYear: 31, monthCode: "M04", day: 1, hour: 12, minute: 34, calendar }, options);
const reiwa1 = Temporal.PlainDateTime.from({ era: "reiwa", eraYear: 1, monthCode: "M06", day: 1, hour: 12, minute: 34, calendar }, options);
const reiwa2 = Temporal.PlainDateTime.from({ era: "reiwa", eraYear: 2, monthCode: "M03", day: 15, hour: 12, minute: 34, calendar }, options);
