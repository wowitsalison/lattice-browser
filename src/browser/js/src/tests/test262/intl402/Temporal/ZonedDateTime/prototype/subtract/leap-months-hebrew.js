...
TemporalHelpers.assertPlainDateTime(
  date1.subtract(months2).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 5783, monthCode: "M04", day: 1, hour: 12, minute: 34, timeZone: "UTC", calendar }, options).subtract(months2).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  date3.subtract(months2n).toPlainDateTime(),
  5784, 6, "M05L", 1, 12, 34, 0, 0, 0, 0, "Subtracting 2 months from M07 in leap year lands in M05L (Adar I)",
  "am", 5784
);

TemporalHelpers.assertPlainDateTime(
  date3.subtract(new Temporal.Duration(0, 3)).toPlainDateTime(),
...
TemporalHelpers.assertPlainDateTime(
  Temporal.ZonedDateTime.from({ year: 5783, monthCode: "M07", day: 1, hour: 12, minute: 34, timeZone: "UTC", calendar }).subtract(months2n).toPlainDateTime(),
